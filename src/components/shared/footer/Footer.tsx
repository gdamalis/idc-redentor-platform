...
const navigation: Navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/iglesiadecristoredentor',
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/idcredentor/',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600">{t('footer.description')}</p>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 text-center sm:mt-20 lg:mt-24 lg:flex lg:justify-between lg:text-left">
          ...
          <p className="text-xs leading-5 text-gray-500">{t('footer.poweredBy')}</p>
        </div>
      </div>
    </footer>
  );
