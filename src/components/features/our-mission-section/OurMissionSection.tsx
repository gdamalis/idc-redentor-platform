          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
              ...
              <Typography component="p" variant="body1" className="mt-6">
                Queremos dar a conocer la buena nueva que Cristo nació, vivió, enseñó, murió, fue
                sepultado, resucitó y ascendió para reinar a la derecha de su Padre hasta su segunda
                aparición.
              </Typography>
              <Typography component="p" variant="body1" className="mt-6">
                El vuelve a redimir, a rescatar y renovar ésta, su buena creación. Queremos ser
                testigos de su poder y de su gran amor para la humanidad.
              </Typography>
