...
- **[product/](./product/README.md)** — the product brain: what the site is, who it serves, and the IN/OUT/DEFERRED scope filter. The `yoke:product-manager` agent grooms against this.
