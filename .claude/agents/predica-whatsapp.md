...
- `siteBaseUrl` — the production canonical (e.g. `https://www.idcredentor.com`) from `config.predica.siteBaseUrl`.
...
```json
{
  ...
  "canonicalUrl": "https://www.idcredentor.com/es-AR/predicas/el-perdon-de-jesus",
