...
featured image unless the human kept theirs), dedups both-locale `bibleVerse` refs **by scripture coordinate**
(reused site-wide), links the preacher, and **creates** the bilingual **DRAFT** `sermon` entry or **updates
